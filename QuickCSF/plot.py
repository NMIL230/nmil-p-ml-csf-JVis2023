...
def plot(qCSFEstimator, graph=None, unmappedTrueParams=None, showNumbers=True, show=True, trueThresholdCurve=None):
	...
	if unmappedTrueParams is not None:
		...
		graph.set_xlim((0.5, 64))
		graph.set_xticks([1, 2, 4, 8, 16, 32, 64])
	...
	if unmappedTrueParams is not None:
		...
		graph.set_yticks([1, 10, 100, 1000])
